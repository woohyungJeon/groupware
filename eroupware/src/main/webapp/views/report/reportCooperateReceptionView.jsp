...
<p style="font-size: 25px;
	...
	<table class="table">
		<tr class="tr_main">
			<td colspan="6" rowspan="3" class="td_main titleTd">수신 업무협조요청서</td>
		...
		<tr class="tr_inform">
			...
			<td class="td_inform2">${cReportDTO.r_drafter }</td>
			<td class="td_inform1 titleTd">부서</td>
			<td class="td_inform2">${cReportDTO.r_department }</td>
			<td class="td_inform1 titleTd">직급</td>
			<td class="td_inform2">${cReportDTO.r_position }</td>
		</tr>
		<tr class="tr_title">
		...
		<tr class="tr_btn">
			<td colspan="8" class="td_btn">
				<input type="hidden" class="seq_ew_draft" value="${cReportDTO.seq_ew_draft}">
					<c:if test="${cReportDTO.r_status == 'N' }">
			...
			&nbsp;&nbsp;
			<input type="button" value="뒤로가기" id="btn" onclick="location.href='${pageContext.request.contextPath }/reportCooperateReceptionList'">
			&nbsp;&nbsp;
