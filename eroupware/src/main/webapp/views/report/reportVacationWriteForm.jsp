...
<form action="${pageContext.request.contextPath }/reportVacationWrite" method="post" class="reportForm" name="reportVacationWriteForm">
	<table class="table">
		<tr class="tr_main">
		...
		<tr class="tr_kinds">
			...
			<td colspan="7">
				<input type="radio" name="r_type" value="정기">정기
				<input type="radio" name="r_type" value="연차">연차
				<input type="radio" name="r_type" value="반차">반차
				<input type="radio" name="r_type" value="병가">병가
				<input type="radio" name="r_type" value="기타">기타
			</td>
		</tr>
		<tr class="tr_date">
			<td class="td_date1">휴가신청<br>날짜</td>
			<td colspan="7">
				<!-- <input type="text" name="r_Start" class="dateInput"  placeholder=" * YY/MM/DD ~ YY/MM/DD "> -->
				<input type="text" class="startDate" readonly="readonly">&nbsp;-&nbsp;<input type="text" class="endDate"readonly="readonly">
				<input type="hidden" name="r_Start" class="r_Start">
			</td>
		</tr>
		<tr class="tr_title">
			<td class="td_title1">제목</td>
			<td colspan="7">
				<input type="text" name="r_title" class="titleInput"  placeholder=" ( * 필수입력 : [휴가신청서] - 제목 ) " value="[휴가신청서] - ">
			</td>
		</tr>
		<tr class="tr_content">
