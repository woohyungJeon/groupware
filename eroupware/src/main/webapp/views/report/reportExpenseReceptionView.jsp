...
<table class="table">
	<tr class="tr_main">
		<td colspan="6" rowspan="3" class="td_main titleTd">수신 지출품의서</td>
	...
	<tr class="tr_btn">
		<td colspan="8" class="td_btn">
			<input type="hidden" class="seq_ew_draft" value="${eReportDTO.seq_ew_draft}">
				<c:if test="${eReportDTO.r_status == 'N' }">
			...
			&nbsp;&nbsp;
			<input type="button" value="뒤로가기" id="btn" onclick="location.href='${pageContext.request.contextPath }/reportExpenseReceptionList'">
			&nbsp;&nbsp;
