...
<p style="font-size: 25px;
	...
	<table class="table">
		<tr class="tr_main">
			<td colspan="6" rowspan="3" class="td_main titleTd">상신 휴가신청서</td>
		...
		<tr class="tr_btn">
			<td colspan="8" class="td_btn">
				<input type="button" value="삭제하기" onclick="location.href='${pageContext.request.contextPath }/reportVacationDelete/${vReportDTO.seq_ew_draft}'">
				&nbsp;&nbsp;
				<input type="button" value="뒤로가기" id="btn" onclick="location.href='${pageContext.request.contextPath }/reportVacationList'">
				&nbsp;&nbsp;
