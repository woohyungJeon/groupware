...
<form action="${pageContext.request.contextPath}/reportExpenseWrite" method="post" class="reportForm" name="reportExpenseWriteForm" enctype="multipart/form-data">
	<table class="table">
		<tr class="tr_main">
		...
		<tr class="tr_title">
			...
			<td colspan="7">
				<input type="text" name="r_title" class="titleInput" placeholder=" ( * 필수입력 : [지출품의서] - 제목 ) " value="[지출품의서] - ">
			</td>
		</tr>
		<tr class="tr_content">
		...
		<tr class="tr_receipt">
			...
			<td colspan="7" class="td_receipt2">
				<input type="file" name="file" class="teceiptFile">
			</td>
		</tr>
		<tr class="tr_aso">
