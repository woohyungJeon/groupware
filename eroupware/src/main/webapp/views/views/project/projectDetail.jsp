...
<div class="projectDetailMainArea">
	...
	<div class="infoArea">
		...
		<div class="projectChartArea">
			...
			<canvas class="projectTotalChart" id="projectTotalChart">
			</canvas>
		</div>
		
		<div class="projectTaskChartArea">
			<div class="projectTaskChart">
...
<%-- 
<div class="newTaskModal modal-overlay">
