...
<form action="${pageContext.request.contextPath }/reportVacationUpdate" method="get">
	<table class="table">
		<tr class="tr_main">
		...
		<tr class="tr_sign">
			<td class="td_sign1"></td>
			<td class="td_sign2"></td>
		</tr>
		<tr class="tr_inform">
		...
		<tr class="tr_date">
			...
			<td colspan="7">
				<input type="text" class="dateInput"  placeholder="*날짜를 입력하세요">
			</td>
		</tr>
		<tr class="tr_title">
			<td class="td_title1">제목</td>
			<td colspan="7">
				<input type="text" class="titleInput"  placeholder="*[휴가신청서] - 휴가종류 ">
			</td>
		</tr>
		<tr class="tr_content">
