...
<div class="div_wrap" style=text-align:center;>
			...
			<tbody>
				<c:forEach var="anonyList" items="${list}">
					<tr style="height: 40px;" class="list_css"
						onclick="location.href='${pageContext.request.contextPath }/anony/${anonyList.anonyNo}'">
	...
	<div class="writebtn_area">
		<input type="button" value="글쓰기" class="writebtn_css" onclick="location.href='${pageContext.request.contextPath }/anony/writeForm'">
	</div>
</div>