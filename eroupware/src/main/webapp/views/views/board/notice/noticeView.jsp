	...
	<div class="table_area">
		<table class="table_css">
			...
			<tr class="tr_third">
				...
				<td colspan="3" class="td_contentsub">${noticeView.content}</td>
			</tr>
			<tr class="tr_fouth">
		...
		<div class="btn_area">
			<input type="button" value="수정" class="btn_modify"
				onclick="location.href='${pageContext.request.contextPath }/notice/noticeUpdateForm/${noticeView.seq }'">
			<input type="button" value="삭제" class="btn_delete"
				onclick="location.href='${pageContext.request.contextPath }/notice/delete/${noticeView.seq }'">
