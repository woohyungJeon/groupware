...
public class VReportDTO {
	...
	private String r_type;       // 휴가종류
	private String r_Start;      // 휴가신청날짜
	...
	public String toString() {
		return "VReportDTO [seq_ew_draft=" + seq_ew_draft + ", r_id=" + r_id + ", r_drafter=" + r_drafter
				+ ", r_draftDate=" + r_draftDate + ", r_department=" + r_department + ", r_position=" + r_position
				+ ", r_type=" + r_type + ", r_Start=" + r_Start + ", r_title=" + r_title + ", r_content=" + r_content
				+ ", r_approver=" + r_approver + ", r_status=" + r_status + ", r_aso=" + r_aso + "]";
	}
