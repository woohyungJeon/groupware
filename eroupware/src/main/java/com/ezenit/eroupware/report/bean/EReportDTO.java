...
public class EReportDTO {
	...
	public String toString() {
		return "EReportDTO [seq_ew_draft=" + seq_ew_draft + ", r_id=" + r_id + ", r_drafter=" + r_drafter
				...
				+ r_status + ", r_aso=" + r_aso + ", filepath=" + filepath + ", getClass()=" + getClass()
